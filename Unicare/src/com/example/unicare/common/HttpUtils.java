...
public class HttpUtils {
	 ...
	 *            本次请求的超时间
	 */
	public static JSONObject sendJSONPost(String url, JSONObject jsonObject)
			throws Exception {
		// 返回的jsonobject对象
		...
		// 设置 Post请求的请求参数
		StringEntity se = new StringEntity(URLEncoder.encode(
				jsonObject.toString(), "utf8"));
...
//	 *            本次请求的超时间
//	 */
//	public static JSONObject sendJSONDelete(String url, JSONObject jsonObject)
//			throws Exception {
//		JSONObject jsonData = new JSONObject();// 返回的jsonobject对象
